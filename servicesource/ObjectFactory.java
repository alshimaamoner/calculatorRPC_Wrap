...
public class ObjectFactory {
    ...
    private final static QName _Mul_QNAME = new QName("http://service/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://service/", "mulResponse");
    private final static QName _DivResponse_QNAME = new QName("http://service/", "divResponse");
    private final static QName _Sub_QNAME = new QName("http://service/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://service/", "subResponse");
    private final static QName _Add_QNAME = new QName("http://service/", "add");
    private final static QName _Div_QNAME = new QName("http://service/", "div");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "div")
