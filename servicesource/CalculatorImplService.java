 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9090/ws/calculate?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://service/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/ws/calculate?WSDL");
    ...
    public CalculatorImpl getCalculatorImplPort() {
        return super.getPort(new QName("http://service/", "CalculatorImplPort"), CalculatorImpl.class);
    }
    ...
    public CalculatorImpl getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "CalculatorImplPort"), CalculatorImpl.class, features);
    }
